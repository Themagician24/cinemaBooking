      ...
      <div className="group grid grid-cols-4 gap-4 md:gap-8 mt-8 max-w-3xl mx-auto">
        ...
        {dummyTrailers.map((trailer) => (
          ...
          >
            ...
            <img src={trailer.image} alt='trailer' className='rounded-lg h-full object-cover brightness-75'/>

            <PlayCircleIcon strokeWidth={1.6} className='absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 h-5 md:w-8 md:h-12 transform '/>
          </div>
        ))}
